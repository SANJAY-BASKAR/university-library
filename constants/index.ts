...
export const FIELD_DESCRIPTIONS = {
  fullName: "Please enter your full name as it appears on official records.",
  email: "Provide a valid email address for account communications.",
  universityId: "Your unique university ID number for verification.",
  password: "Create a secure password with at least 8 characters.",
  universityCard: "Upload a clear image of your University ID card.",
};
